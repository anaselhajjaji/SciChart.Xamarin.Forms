...
namespace SciChart.Xamarin.Views.Utility
{
    internal class ComparableUtil
    {
        ...
        public static TComparable MaxValue<TComparable>() where TComparable : IComparable
        {
        ...
        public static TComparable Zero<TComparable>()
        {
            var comparableType = typeof(TComparable);
            if (_maxValues.ContainsKey(comparableType))
            {
        ...
        public static TComparable MinValue<TComparable>() where TComparable : IComparable
        {
            var comparableType = typeof(TComparable);
            if (_minValues.ContainsKey(comparableType))
            {
        ...
        public static bool IsValidComparableType<TComparable>() where TComparable : IComparable
        {
            return IsValidComparableType(typeof(TComparable));
        }

        public static bool IsValidComparableType(Type comparableType)
        {
            return _minValues.ContainsKey(comparableType);
        }

        public static TComparable Max<TComparable>(TComparable first, TComparable second) where TComparable : IComparable
        {
            return first.CompareTo(second) > 0 ? first : second;
        }

        public static TComparable Min<TComparable>(TComparable first, TComparable second) where TComparable : IComparable
        {
            return second.CompareTo(first) > 0 ? first : second;
        }

        public static TComparable Max<TComparable>(TComparable a, TComparable b, TComparable c, TComparable d) where TComparable : IComparable
        {
            return Max(a, Max(b, Max(c, d)));
        }

        public static TComparable Min<TComparable>(TComparable a, TComparable b, TComparable c, TComparable d) where TComparable : IComparable
        {
            return Min(a, Min(b, Min(c, d)));
        }

        public static bool IsDefined(IComparable comparable)
        {
        ...
        public static bool CanChangeType(double value, Type conversionType)
        {
            var result = false;
            ...
            else if (conversionType == typeof(Int64) || conversionType == typeof(TimeSpan))
            {
